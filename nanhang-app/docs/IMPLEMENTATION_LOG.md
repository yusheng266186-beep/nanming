...
## 2026-09-12 / nanming-totp：AI 固定访问码改为动态码（进行中）
...
- 脱敏证据：[线上TOTP](verification/nanming-totp-online-2026-09-12.json)。待办：同步文档、提交推送、等待Pages发布并核对公网资源；随后把原始种子和认证器参数直接交给负责人。TASK与门禁不变。
